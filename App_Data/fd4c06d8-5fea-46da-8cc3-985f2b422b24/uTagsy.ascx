        ...
        var uTagsy = new function () {
            ...
            this.Init = function () {
                ...
                if (tagString != '' && tagString != '""') {
                    ...
                    //tagString = "";
                    uTagsy.tags = tagString.split(',');

                    // create tags
                    for (var i = 0; i < uTagsy.tags.length; i++) {
                        uTagsy.createTagForNode(uTagsy.tags[i]);
                    }
                }
                ...
                if (jsonText != '' && jsonText != '""') {
                    ...
                    for (var i = 0; i < uTagsy.document.tags.length; i++) {
                        uTagsy.createTagForDocumentType(uTagsy.document.tags[i]);
            ...
            $('input[id$=layer_save],input[id$=layer_publish],input[id$=body_UnPublishButton]').click(function () {
